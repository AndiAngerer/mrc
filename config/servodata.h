...
const float servoConfig[6][7] = {
    { pin_servo_0,  150*DEG_TO_RAD, 2360.00, 540.00, -110.57*DEG_TO_RAD, 60.57*DEG_TO_RAD, 0 },
    { pin_servo_1,  150*DEG_TO_RAD, 2400.00, 1000.00, -60.57*DEG_TO_RAD, 79.22*DEG_TO_RAD, 0 },
    { pin_servo_2,  150*DEG_TO_RAD, 600.00, 2330.00, -17.57*DEG_TO_RAD, 63.41*DEG_TO_RAD, 0 },
    { pin_servo_3,  150*DEG_TO_RAD, 559.00, 2309.00, -65.57*DEG_TO_RAD, 170.31*DEG_TO_RAD, 0 },
    { pin_servo_4,  150*DEG_TO_RAD, 806.00, 2173.00, -120.03*DEG_TO_RAD, 50.02*DEG_TO_RAD, 0 },
