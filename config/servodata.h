...
const float servoConfig[6][7] = {
    { pin_servo_0,  150*DEG_TO_RAD, 540.00, 2360.00, -60.57*DEG_TO_RAD, 110.57*DEG_TO_RAD, 0 },
    { pin_servo_1,  150*DEG_TO_RAD, 1000.00, 2400.00, -79.22*DEG_TO_RAD, 60.57*DEG_TO_RAD, 0 },
